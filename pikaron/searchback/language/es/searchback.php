...
$lang = array_merge($lang, array(
    ...
    // ACP
    'ACP_SEARCH_BACK_SETTINGS'          => 'Extensión: Search Back',
    ...
    // INSTALL
    'SEARCHBACK_PHPBB_ERROR'            => 'Search Back NO se puede instalar.<br><br>- Se requiere phpBB 3.3.0 o posterior.',
    'SEARCHBACK_PHP_ERROR'              => 'Search Back NO se puede instalar.<br><br>- Se requiere php 7.1.0 o posterior.',
    'SEARCHBACK_OLD_VERSION'            => 'Search Back NO se puede instalar.<br><br>Existe una versión obsoleta de la extension instalada.<br><br>Antes de instalar la nueva version, es necesario desinstalar completamente cualquier version < 3.3.0.',
));
