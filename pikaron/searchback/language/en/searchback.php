...
$lang = array_merge($lang, array(
    ...
    // INSTALL
    'SEARCHBACK_PHPBB_ERROR'            => 'Search Back can NOT be installed.<br><br>- phpBB 3.3.0 or later is required.',
    'SEARCHBACK_PHP_ERROR'              => 'Search Back can NOT be installed.<br><br>- php 7.1.0 or later is required.',
    'SEARCHBACK_OLD_VERSION'            => 'Search Back CANNOT be installed.<br><br>There is an outdated version of the extension installed.<br><br>Before installing the new version, it is necessary to completely uninstall any version < 3.3. 0.',
));
